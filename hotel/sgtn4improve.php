...
?>
	 ...
	 <table>
	 <tr>
					<th><h3 style="color:#C84510;"><b>Give your valuable suggestion for our hotel</b></h3></th>
					</tr>
					<tr>
					<td><input style="width:200px;height:75px;border-radius:40px"type="text" name="sgtn" placeholder="Enter suggestion" title="Suggestion"></td>
...
{
$sgtn=$_POST['sgtn'];
if(mysqli_query($db,"insert into sgtn4improve(sgtn)value('$sgtn')"))	
	{

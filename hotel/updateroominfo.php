...
?>
	...
	<td width="17%" height="50px"><center><input type="taxt" name="username"></center></td>
	 ...
	 <td><input style="width: 80px; height: 30px; border-radius: 20px; opacity: 1;color:blue;" type="submit" name="update" value="Update"></td>	
...
if(isset($_POST['update']))
{
                ...
                $roomno=$_POST['roomno'];	
           	     $q1="UPDATE roominfo SET roomtype='$roomtype',cid='$cid',cod='$cod',members='$members',roomno='$roomno' where username='$username'";

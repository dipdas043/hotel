...
<body>
<div id ="full">
<div style="background-image: url('img/abouthotel.jpg'); width: 100%;height: 650px; ">
   <div id ="header">
      <?php
...
?>
	 ...
	 <center><div id="banner" style="background: rgba(185,185,185,0.7);width:80%;height:620px;padding:10px;"><br><br><br><br><br><br><br>
	<div id="wc">
 ...
 <div id="g1">
	 ...
	 <center>
	 <h2><font color="#0A0AE9">Dhaka Booking office</font></h2>
	 <font color="#1E6F69">
	 office:Kawran Bazar,Dhaka<br>
	 phone no.:#########<br>
	 Email:########<br>
	 </font>
	 </center>
	 ...
	 <div id ="hb"><img src="img/hb.jpg" width="100%">
	   <center>
	 <h2><font color="#0A0AE9">Chattogram Booking office</font></h2>
	 <font color="#1E6F69">
	 office:foyz lake,Chattogram<br>
	 phone no.:#########<br>
	 Email:########<br>
	 </font>
	 </center>
	 ...
	 <div id ="hr"><img src="img/hr.jpg" width="100%">
	  <center>
	 <h2><font color="#0A0AE9">Khulna Booking office</font></h2>
	 <font color="#1E6F69">
	 office:Pakshi,Khula<br>
	 phone no.:#########<br>
	 Email:########<br>
	 </font>
	 </center>
